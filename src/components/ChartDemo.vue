<template>
    <div class="chart-content">
        <!-- <ve-line :data="chartData" :settings="chartSettings" height="100%" :colors="colors"></ve-line> -->
        <ve-histogram :data="chartData" :settings="chartSettings" height="100%" :colors="colors"></ve-histogram>
